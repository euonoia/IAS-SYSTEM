...
<div class="bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 shadow-2xl p-8 mb-8">
    ...
    <div class="bg-white/10 rounded-2xl border border-white/20 shadow-lg overflow-hidden text-nowrap overflow-x-auto">
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-white/10">
                ...
                <tr class="hover:bg-white/5 transition-colors">
                    <td class="px-6 py-4 font-bold text-white">{{ $med->name }}</td>
